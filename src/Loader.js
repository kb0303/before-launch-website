					...
					<div className="col-lg-8 mt-5">
						<div className="notification-box w-100 h-100">
							<div className="d-flex justify-content-between align-items-center border-bottom p-3">
								<p className="mb-0 fs-3 fw-bold" style={{ color: "#007fda" }}> Please Wait...</p>
								<div>
							...
							<div className="p-5">
								<div className="row justify-content-center align-items-center mt-3">
									<div className="col-lg-8">
										<p className="fs-6 fw-bold">Based on the answers provided by you; We are trying to
											determine
											resolution. Kindly be patient</p>
										<p className="mt-4 middile-text-p fw-bold">You will be provided with 3 probable causes, and the
								...
								<div className="d-flex justify-content-center align-items-center mt-5 mb-4">
									...
									<p className="mb-0 ms-3 fs-6 fw-bold">Waiting for action to be completed</p>
								</div>
							</div>
						</div>
					</div>
